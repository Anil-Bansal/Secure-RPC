...
def ns_auth():
    ...
    with socket(AF_INET, SOCK_STREAM) as sock:
        ...
        number_of_server=sock.recv(1024)
        number_of_server=decode(number_of_server)
        print(number_of_server)
        ...
        print("Following File Servers are available")
        for i in range((int)(number_of_server)):
            print("File Server ",i+1)
...
#last step===========================================================
            ...
            sock.sendall(Ra3)
            print("You are authenticated to run following commands")
            print("pwd: Get the present working directory")
            print("ls: Get all the files in working directory")
            print("cat: Get the contents of the file")
            print("cp: Copy contents of one file to other")
